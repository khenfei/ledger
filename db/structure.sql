...
--
-- Name: expenses_category; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.expenses_category AS ENUM (
    'apparel',
    'entertainment',
    'grocery',
    'meal',
...
CREATE TABLE public.expenses (
    id bigint NOT NULL,
    category public.expenses_category,
    total numeric(10,2),
...
CREATE INDEX index_expenses_on_tags ON public.expenses USING gin (tags);
